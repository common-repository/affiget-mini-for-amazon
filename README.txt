...
== Changelog ==
= Version 1.1.6 (2015-9-24) =
* Fix: Product synch no longer attaches category/tag/description for existing (not-new) reviews (still attaches a featured image if this is none).
